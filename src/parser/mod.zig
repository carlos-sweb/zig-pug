...
pub const Parser = struct {
    ...
    pub fn parseStatement(self: *Parser) anyerror!*ast.AstNode {
        return switch (self.current.type) {
            ...
            .JsStatement, .BufferedCode, .UnescapedCode => try code_parser.parseCode(self),
            ...
            .Block   => try templates_parser.parseBlock(self, .Replace),
            .Append  => try templates_parser.parseBlock(self, .Append),
            .Prepend => try templates_parser.parseBlock(self, .Prepend),
            .Doctype => {
