...
- `libzig-pug.dylib` - Librería dinámica para enlazado dinámico en tiempo de ejecución
...
### Librería dinámica (`libzig-pug.dylib`)
...
sudo cp libzig-pug.dylib /usr/local/lib/
